...
| `batch_triple_compare.py` | **Baseline + native source + transfer target**, multi-**coef**, YAML + optional **prompt file** |
| `evaluate_jsonl.py` | JSONL → **CSV** and/or **HTML report** (metrics + optional **OpenAI** phobia judge) |
